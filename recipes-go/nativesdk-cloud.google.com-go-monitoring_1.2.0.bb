SUMMARY = "go.mod: cloud.google.com/go/monitoring"
HOMEPAGE = "https://pkg.go.dev/cloud.google.com/go/monitoring"
DEFAULT_PREFERENCE = "${SCA_DEFAULT_PREFERENCE}"
# License is determined by the modules included and will be therefore computed
LICENSE = "${@' & '.join(sorted(set(x for x in (d.getVar('GOSRC_LICENSE') or '').split(' ') if x)))}"

# inject the needed sources
require cloud.google.com-go-monitoring-sources.inc
EXTRA_DEPENDS += "\
...
"
GO_IMPORT = "cloud.google.com/go/monitoring"
inherit gosrc
inherit nativesdk
